...
(function( root, factory ) {
	...
	function showPreview( url ) {
		...
		dom.overlay.innerHTML = [
			'<header>',
				'<a class="close" href="#"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>',
				'<p><i class="fa fa-globe"></i>&nbsp;'+ url +'</p>',
				'<a class="external" href="'+ url +'" target="_blank" style="display:none;"><span class="icon"></span></a>',
			'</header>',
