...
<div class="menu" id="menu">
    ...
    <div class="main" id="main">
        ...
        <div class="sideButtons clearfix">
            ...
            <a href="#exportModal" data-toggle="modal" class="btn btn-info btn-sm btn-embossed actionButtons"><span class="fui-export"></span> Export</a>
        </div>
...
<div class="container">
    ...
    <header class="clearfix" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
        ...
        <a href="#" id="clearScreen" class="btn btn-danger btn-embossed pull-right actionButtons"><span class="fui-trash"></span></a>
        <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-info btn-embossed pull-right actionButtons"><span class="fui-export"></span> Export Site</a>
        <a href="javascript:void(0)" id="savePage" class="btn btn-info btn-embossed pull-right actionButtons"><span class="fa fa-save "></span> Save</a>
        <div class="modes">
