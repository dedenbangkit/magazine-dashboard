    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse topnavigation">
            <div class="navbar-left navbar-issue">
                ...
                <div class="subtitle">{{date('d-m-Y H:I:s',strtotime($issue->created_at))}} > <span
                            id="pageTitle"><span>index</span></span></div>
            </div>
            ...
            <div class="toolbar" id="responsive-toolbar">
                <ul>
                    <li><a href="#" data-responsive="phone"><img
                                    src="{{asset('builder_front/images/icon/icon-phone.png')}}" alt=""> Mobile</a></li>
                    <li class="active"><a href="#" data-responsive="tablet-sm"><img
                                    src="{{asset('builder_front/images/icon/icon-tablet.png')}}" alt=""> Small
                            Tablet</a></li>
                    <li><a href="#" data-responsive="tablet-lg"><img
                                    src="{{asset('builder_front/images/icon/icon-tablet.png')}}" alt=""> Large
                            Tablet</a></li>
                </ul>
            </div>
...
<header>
    <a class="btn btn-info btn-embossed actionButtons" href="#" id="pageSetting"><span class="fui-gear"></span> Page
        Settings</a>
    <a class="btn btn-info btn-embossed actionButtons" href="#" id="editingMode"><span class="fui-play"></span> Start
        Editing</a>
    ...
    <a href="javascript:void(0)" id="savePage" data-toggle="modal"
       class="btn btn-info btn-embossed pull-right actionButtons"><span class="fui-export"></span> Save Current Page</a>
...
<div id="styleEditor" class="styleEditor">
    ...
    <div class="tab-content">
                        ...
                        <div class="buttons" style="width:100%">
                                    <span class="btn btn-primary btn-sm btn-embossed btn-file" style="width:100%">
                                        ...
                                        <span class="fileinput-new" data-trigger="fileinput"><span
                                                    class="fui-image"></span>&nbsp;&nbsp;Upload image</span>
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="buttons" style="width:100%">
                                    <span class="btn btn-primary btn-sm btn-embossed btn-file" style="width:100%">
                                        ...
                                        <span class="fileinput-new" data-trigger="fileinput"><span
                                                    class="fui-image"></span>&nbsp;&nbsp;Upload background</span>
                                        <span class="fileinput-exists"><span class="fui-gear"></span>&nbsp;&nbsp;Change</span>
                                    </span>
                            <a style="width:100%" href="#" class="btn btn-danger btn-sm btn-embossed fileinput-exists"
                               data-dismiss="fileinput"><span class="fui-alert"></span>&nbsp;&nbsp;Reset</a>
        ...
        <div class="tab-pane videoTab" id="video_Tab">
            ...
            <input type="text" class="form-control margin-bottom-20" id="vimeoID" placeholder="Enter a Vimeo video ID"
                   value="">
    ...
    <div class="margin-bottom-5">
        <button type="button" class="btn btn-primary btn-embossed btn-sm btn-block" id="saveStyling"><span
                    class="fui-check-inverted"></span> Apply Changes
        </button>
    </div>

    <div class="sideButtons clearfix">
        <button type="button" class="btn btn-inverse btn-embossed btn-xs" id="cloneElementButton"><span
                    class="fui-windows"></span> Clone
        </button>
        <button type="button" class="btn btn-danger btn-embossed btn-xs" id="removeElementButton"><span
                    class="fui-cross-inverted"></span> Remove
        </button>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group hidden">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" name="doctype" id="doctype" placeholder="Doc type"
                                   value="<!--DOCTYPE html -->">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="exportCancel">
                        Cancel & Close
                    </button>
                    <button type="submit" type="button" class="btn btn-primary btn-embossed" id="exportSubmit">Export
                        Now
                    </button>
                </div>
            </div><!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteBlockConfirm">
                    Delete
                </button>
            </div>
        </div><!-- /.modal-content -->
...
<div class="modal fade small-modal" id="deleteAll" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancel & Close</button>
                <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteAllConfirm">Delete
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade small-modal" id="deletePage" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="deletePageCancel">
                    Cancel & Close
                </button>
...
//                    console.log(contentpath)
                            ...
                            window.open(myImage, "toDataURL() image", "width=800, height=800");
                        }
                    });
                }
            }
    ...
    function newPage(pageTittle, pageContent, pageID, index,revision,revID) {
        ...
        $('select#internalLinksDropdown').selectpicker({
            style: 'btn-sm btn-inverse btn-embossed',
